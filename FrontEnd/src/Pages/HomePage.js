...
const HomePage = () => {
  ...
  const handleRequest = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://127.0.0.1:8082/api/v1/auth/addProducts', data);
  
      // Assuming the backend responds with a message object
      const message = response.data.message; // Update this line to get the specific message

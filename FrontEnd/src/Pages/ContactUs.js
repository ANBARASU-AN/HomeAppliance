...
const ContactUs = () => {
  ...
  const handleRequest = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://127.0.0.1:8082/api/v1/auth/addUpdate', data);
      ...
      // Set the message to display
      setRequestStatus({ message: 'Error requesting product. Please try again later.' });
      ...
      <center>
        <div className="container1">
          <form>
            ...
            {requestStatus && (
              <p className={requestStatus.message === 'Product Request is Added Successfully' ? 'success' : 'error'}>
